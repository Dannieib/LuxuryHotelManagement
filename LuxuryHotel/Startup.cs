...
namespace LuxuryHotel
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IRoomsAppService, RoomsAppService>();
            services.AddSingleton<IMongoBaseRepository, MongoBaseRepository>();
            services.AddSingleton<IMongoDBInit, MongoDBInit>();
        }
